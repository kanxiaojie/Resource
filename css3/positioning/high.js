 ...
 */
(function(C, Z) {
    typeof module === "object" && module.exports ? module.exports = C.document ? Z(C) : Z: C.Highcharts = Z(C)
    ...
    function(C) {
        ...
        function K(a, b, c) {
            ...
            else if (r(b) && X(b)) for (d in b) a.setAttribute(d, b[d]);
            return e
        }
        function ta(a) {
            return Da(a) ? a: [a]
            ...
            for (var c = "{",
                ...
                if (d) {
                    ...
                    if (f.length) f = f.join(":"),
                        ...
                        h = S.lang,
                        i = void 0,
                        /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = w.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: ""))) : e = Pa(f, e)
                }
                k.push(e);
                a = a.slice(c + 1);
                c = (d = !d) ? "}": "{"
        ...
        function Eb() {
            ...
            jb = function(a, c, d, h, i, k) {
                var j;
                b ? (j = pa.UTC.apply(0, arguments), j += Ya(j)) : j = (new pa(a, c, p(d, 1), p(h, 0), p(i, 0), p(k, 0))).getTime();
                return j
            };
            ub = c + "Minutes";
            vb = c + "Hours";
        ...
        var z, A = C.document,
            ...
            qa = W.PI,
            ha = qa * 2 / 360,
            za = C.navigator && C.navigator.userAgent || "",
            Kb = C.opera,
            ...
            ca = A && A.createElementNS && !!A.createElementNS(Ga, "svg").createSVGRect,
            Pb = La && parseInt(za.split("Firefox/")[1], 10) < 4,
            ia = A && !ca && !ya && !!A.createElement("canvas").getContext,
            cb,
            db,
            Mb = {},
            zb = 0,
        ...
        qb.prototype = {
            ...
            run: function(a, b, c) {
                ...
                this.pos = 0;
                e.elem = this.elem;
                if (e() && Ha.push(e) === 1) e.timerId = setInterval(function() {
                        for (f = 0; f < Ha.length; f++) Ha[f]() || Ha.splice(f--, 1);
            ...
            step: function(a) {
                ...
                if (c.attr && !c.element) c = !1;
                    ...
                    a && e && e.call(c);
                    c = !1
                } else this.pos = d.easing((b - this.startTime) / f),
            ...
            initPath: function(a, b, c) {
                ...
                e && (k(b), k(c));
                if (d <= c.length / f && b.length === c.length) for (; d--;) c = c.slice(0, f).concat(c),
                h && (c = c.concat(c.slice(c.length - f)));
                a.shift = 0;
                if (b.length) for (a = c.length; b.length < a;) d = b.slice().splice(b.length / i - f, f * i),
                e && (d[f - 6] = d[f - 2], d[f - 5] = d[f - 1]),
                    [].splice.apply(b, [b.length / i, 0].concat(d));
                return [b, c]
            }
        };
        ...
        Pa = function(a, b, c) {
            if (!r(b) || isNaN(b)) return S.lang.invalidDate || "";
        ...
        ka = function(a, b) {
            var c;
            if (b === "width") return Math.min(a.offsetWidth, a.scrollWidth) - ka(a, "padding-left") - ka(a, "padding-right");
            else if (b === "height") return Math.min(a.offsetHeight, a.scrollHeight) - ka(a, "padding-top") - ka(a, "padding-bottom");
        ...
        Na = function(a) {
            for (var b = Ha.length; b--;) if (Ha[b].elem === a) Ha[b].stopped = !0
        };
        o = function(a, b) {
        ...
        V = function(a, b, c) {
            ...
            var f, g = a.hcEvents,
                h;
            if (g) b ? (f = g[b] || [], c ? (h = ra(c, f), h > -1 && (f.splice(h, 1), g[b] = f), d(b, c)) : (e(), g[b] = [])) : (e(), a.hcEvents = {})
        };
        H = function(a, b, c, d) {
            var e;
            e = a.hcEvents;
            var f, g, c = c || {};
            if (A.createEvent && (a.dispatchEvent || a.fireEvent)) e = A.createEvent("Events"),
                e.initEvent(b, !0, !0),
                e.target = a,
                s(e, c),
        ...
        Wa = function(a, b, c) {
            ...
            c.curAnim = D(b);
            for (h in b) g = new qb(a, c, h),
                f = null,
                h === "d" ? (g.paths = g.initPath(a, a.d, b.d), g.toD = b.d, d = 0, f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(ka(a, h)) || 0, h !== "opacity" && (e = "px")),
            f || (f = b[h]),
            f.match && f.match("px") && (f = f.replace(/px/g, "")),
                g.run(d, f, e)
        };
        if (C.jQuery) C.jQuery.fn.highcharts = function() {
            var a = [].slice.call(arguments);
            if (this[0]) return a[0] ? (new(w[xa(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : O[K(this[0], "data-highcharts-chart")]
        };
        A && !A.defaultView && (ka = function(a, b) {
            ...
            b === "opacity" && (b = "filter");
            if (c) return a.style.zoom = 1,
                Math.max(a[c] - 2 * ka(a, "padding"), 0);
        ...
        ja.prototype = {
            ...
            init: function(a) {
                var b, c, d, e;
                if ((this.input = a) && a.stops) this.stops = Ba(a.stops,
                    function(a) {
                        return new ja(a[1])
                    });
                else for (d = this.parsers.length; d--&&!c;) e = this.parsers[d],
                (b = e.regex.exec(a)) && (c = e.parse(b));
                this.rgba = c || []
            },
            get: function(a) {
                var b = this.input,
            ...
            brighten: function(a) {
                var b, c = this.rgba;
                if (this.stops) o(this.stops,
                    function(b) {
                        b.brighten(a)
                    });
                else if (ma(a) && a !== 0) for (b = 0; b < 3; b++) c[b] += F(a * 255),
                c[b] < 0 && (c[b] = 0),
                c[b] > 255 && (c[b] = 255);
                return this
            },
        ...
        P.prototype = {
            ...
            colorGradient: function(a, b, c) {
                ...
                if (f) {
                    ...
                    f === "radialGradient" && n && !r(g.gradientUnits) && (h = g, g = D(g, d.getRadialAttr(n, h), {
                        gradientUnits: "userSpaceOnUse"
                    }));
                    for (q in g) q !== "id" && v.push(q, g[q]);
                    for (q in j) v.push(j[q]);
                    v = v.join(",");
                    i[v] ? n = i[v].attr("id") : (g.id = n = "highcharts-" + zb++, i[v] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], o(j,
                        function(a) {
                            a[1].indexOf("rgba") === 0 ? (e = ja(a[1]), l = e.get("rgb"), m = e.get("a")) : (l = a[1], m = 1);
            ...
            applyTextShadow: function(a) {
                ...
                g ? this.css(e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), o(a.split(/\s?,\s?/g),
                    function(a) {
                        var d = b.firstChild,
                            e, f, a = a.split(" ");
                        e = a[a.length - 1]; (f = a[a.length - 2]) && o(c,
                            function(a, c) {
                                var g;
            ...
            updateShadows: function(a, b, c) {
                for (var d = this.shadows,
                         e = d.length; e--;) c.call(d[e], a === "height" ? Math.max(b - (d[e].cutHeight || 0), 0) : a === "d" ? this.d: b, a, d[e])
            },
            addClass: function(a) {
                var b = this.element,
                    c = K(b, "class") || "";
            ...
            on: function(a, b) {
                ...
                db && a === "click" ? (d.ontouchstart = function(a) {
                    ...
                    d.onclick = function(a) { (za.indexOf("Android") === -1 || pa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
                    }) : d["on" + a] = b;
                return this
            },
            ...
            align: function(a, b, c) {
                ...
                f = e.alignedObjects;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = b, !c || xa(c)) this.alignTo = d = c || "renderer",
                        na(f, this),
                        f.push(this),
                        c = null
            ...
            getBBox: function(a, b) {
                ...
                f = p(b, this.rotation);
                g = f * ha;
                e !== z && (q = ["", f || 0, i && i.fontSize, h.style.width].join(","), q = e === "" || Qb.test(e) ? "num:" + e.toString().length + q: e + q);
                q && !a && (c = m[q]);
                if (!c) {
                    if (h.namespaceURI === Ga || d.forExport) {
                        try {
                            l = this.fakeTS &&
                                ...
                                La && j.textShadow ? (k = j.textShadow, j.textShadow = "") : l && l("none"),
                                c = h.getBBox ? s({},
                                    h.getBBox()) : {
                                    width: h.offsetWidth,
                    ...
                    if (d.isSVG) {
                        ...
                        if (f) c.width = Q(e * aa(g)) + Q(d * U(g)),
                            c.height = Q(e * U(g)) + Q(d * aa(g))
                    }
                    if (q) {
            ...
            shadow: function(a, b, c) {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= i; e++) {
                        ...
                        if (c) K(f, "height", t(K(f, "height") - h, 0)),
                            f.cutHeight = h;
            ...
            titleSetter: function(a) {
                ...
                b || (b = A.createElementNS(Ga, "title"), this.element.appendChild(b));
            ...
            zIndexSetter: function(a, b) {
                ...
                if (e) {
                    ...
                    d = c.childNodes;
                    for (i = 0; i < d.length && !h; i++) if (e = d[i], f = e.zIndex, e !== g && (F(f) > a || !r(a) && r(f))) c.insertBefore(g, e),
                        h = !0;
                    h || c.appendChild(g)
                }
                return h
        ...
        Ca.prototype = {
            ...
            init: function(a, b, c, d, e, f) {
                ...
                this.boxWrapper = d;
                this.alignedObjects = [];
                this.url = (La || mb) && A.getElementsByTagName("base").length ? C.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                this.createElement("desc").add().element.appendChild(A.createTextNode("Created with Highcharts 4.2.4"));
            ...
            buildText: function(a) {
                for (var b = a.element,
                         c = this,
                         d = c.forExport,
                         e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = K(b, "x"), j = a.styles, l = a.textWidth, m = j && j.lineHeight, n = j && j.textShadow, q = j && j.textOverflow === "ellipsis", v = g.length, y = l && !a.added && this.box, sa = function(a) {
                        return m ? F(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize: j && j.fontSize || c.style.fontSize || 12, a).h
                    },
                         x = function(a) {
                             return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                         }; v--;) b.removeChild(g[v]); ! f && !n && !q && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, y && y.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e,
                    function(e, f) {
                        var g, m = 0,
                        ...
                        o(g,
                            function(e) {
                                if (e !== "" || g.length === 1) {
                                    var n = {},
                                        v = A.createElementNS(Ga, "tspan"),
                                        y;
                                    h.test(e) && (y = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), K(v, "style", y));
                                    i.test(e) && !d && (K(v, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(v, {
                                        cursor: "pointer"
                                    }));
                                    e = x(e.replace(/<(.|\n)*?>/g, "") || " ");
                                    if (e !== " ") {
                                        ...
                                        K(v, n);
                                        b.appendChild(v); ! m && f && (!ca && d && L(v, {
                                            display: "block"
                                        }), K(v, "dy", sa(v)));
                                        if (l) {
                                            for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, u, r, t = [], s = sa(v), B = 1, z = a.rotation, w = e, D = w.length; (p || q) && (n.length || t.length);) a.rotation = 0,
                                                o = a.getBBox(!0),
                                                r = o.width,
                                            !ca && c.forExport && (r = c.measureSpanWidth(v.firstChild.data, a.styles)),
                                                o = r > l,
                                            u === void 0 && (u = o),
                                                q && u ? (D /= 2, w === "" || !o && D < 0.5 ? n = [] : (o && (u = !0), w = e.substring(0, w.length + (o ? -1 : 1) * ua(D)), n = [w + (l > 3 ? "\u2026": "")], v.removeChild(v.firstChild))) : !o || n.length === 1 ? (n = t, t = [], n.length && (B++, v = A.createElementNS(Ga, "tspan"), K(v, {
                                                    dy: s,
                                                    x: k
                                                }), y && K(v, "style", y), b.appendChild(v)), r > l && (l = r)) : (v.removeChild(v.firstChild), t.unshift(n.pop())),
                                            n.length && v.appendChild(A.createTextNode(n.join(" ").replace(/- /g, "-")));
            ...
            button: function(a, b, c, d, e, f, g, h, i) {
                ...
                y = h.style;
                delete h.style;
                N(k.element, ya ? "mouseover": "mouseenter",
                    function() {
                        j !== 3 && k.attr(f).css(q)
                    });
                N(k.element, ya ? "mouseout": "mouseleave",
                    function() {
                        j !== 3 && (l = [e, f, g][j], m = [n, q, v][j], k.attr(l).css(m))
                    });
                k.setState = function(a) { (k.state = j = a) ? a === 2 ? k.attr(g).css(v) : a === 3 && k.attr(h).css(y) : k.attr(e).css(n)
                };
                return k.on("click",
                    function(a) {
                        j !== 3 && d.call(k, a)
            ...
            symbol: function(a, b, c, d, e, f) {
                ...
                f && s(h, f);
                    ...
                    j = a.match(k)[1],
                    a = Mb[j] || f && f.width && f.height && [f.width, f.height],
                    h = this.image(j).attr({
                        x: b,
                        y: c
                    }),
                    ...
                    a ? l(h, a) : (h.attr({
                        ...
                        onload: function() {
                            ...
                            g.imgCount--;
                            if (!g.imgCount && O[g.chartIndex].onload) O[g.chartIndex].onload()
                        },
                        src: j
                    }), this.imgCount++);
                return h
            ...
            fontMetrics: function(a, b) {
                var c, d, a = a || this.style.fontSize; ! a && b && C.getComputedStyle && (b = b.element || b, a = (c = C.getComputedStyle(b, "")) && c.fontSize);
            ...
            label: function(a, b, c, d, e, f, g, h, i) {
                ...
                J = function() {
                    var a, b;
                    a = l.element.style;
                    n = (p === void 0 || x === void 0 || j.styles.textAlign) && r(l.textStr) && l.getBBox();
                    ...
                    if (A) {
                        if (!m) a = ob,
                            b = (h ? -w: 0) + ob,
                            j.box = m = d ? k.symbol(d, a, b, j.width, j.height, Y) : k.rect(a, b, j.width, j.height, 0, Y["stroke-width"]),
                        m.isImg || m.attr("fill", "none"),
                            m.add(j);
                        m.isImg || m.attr(s({
                                width: B(j.width),
                                height: B(j.height)
                ...
                E = function() {
                    var a = j.styles,
                        ...
                        c;
                    c = h ? 0 : w;
                    if (r(p) && n && (a === "center" || a === "right")) b += {
                            center: 0.5,
                            right: 1
                        } [a] * (p - n.width);
                    if (b !== l.x || c !== l.y) l.attr("x", b),
                    c !== z && l.attr("y", c);
                    l.x = b;
                    l.y = c
                };
        ...
        s(P.prototype, {
            ...
            setSpanRotation: function(a, b, c) {
                var d = {},
                    e = ya ? "-ms-transform": mb ? "-webkit-transform": La ? "MozTransform": Kb ? "-o-transform": "";
            ...
            var Bb = {
                    ...
                    return s(e, {
                        ...
                        getCSS: function(a) {
                            var b = a.element,
                                ...
                                f = d + this.height,
                                d = {
                                    clip: "rect(" + B(a ? e: d) + "px," + B(a ? f: b) + "px," + B(a ? b: f) + "px," + B(a ? d: e) + "px)"
                                }; ! a && lb && c === "DIV" && s(d, {
                                width: b + "px",
                                height: f + "px"
                            });
                ...
                color: function(a, b, c, d) {
                    ...
                    if (i) {
                        var j, l, m = a.linearGradient || a.radialGradient,
                            ...
                            u, r = [],
                            t = function() {
                                h = ['<fill colors="' + r.join(",") + '" opacity="', v, '" o:opacity2="', q, '" type="', i, '" ', x, 'focus="100%" method="any" />'];
                        ...
                        o(a,
                            function(a, b) {
                                g.test(a[1]) ? (f = ja(a[1]), j = f.get("rgb"), l = f.get("a")) : (j = a[1], l = 1);
                                r.push(a[0] * 100 + "% " + j);
                                b ? (v = l, y = j) : (q = l, p = j)
                            });
                        if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0,
                            ...
                            n = m.x2 || m[2] || 0,
                            m = m.y2 || m[3] || 0,
                            x = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / qa) + '"',
                            t();
                        else {
                            var k = m.r,
                                Y = k * 2,
                                ...
                                z = b.radialReference,
                                A, k = function() {
                                    z && (A = d.getBBox(), w += (z[0] - A.x) / A.width - 0.5, B += (z[1] - A.y) / A.height - 0.5, Y *= z[2] / A.width, s *= z[2] / A.height);
                                    x = 'src="' + S.global.VMLRadialGradientURL + '" size="' + Y + "," + s + '" origin="0.5,0.5" position="' + w + "," + B + '" color2="' + p + '" ';
                                    t()
                                };
                            d.added ? k() : d.onAdd = k;
                            k = y
                        } else k = j
                    } else if (g.test(a) && b.tagName !== "IMG") f = ja(a),
                        d[c + "-opacitySetter"](f.get("a"), c, b),
                        k = f.get("rgb");
                    else {
                ...
                symbols: {
                    ...
                    rect: function(a, b, c, d, e) {
                        return Ca.prototype.symbols[!r(e) || !e.r ? "square": "callout"].call(0, a, b, c, d, e)
                    }
                }
            };
        ...
        var Nb;
        if (ia) w.CanVGRenderer = M = function() {
        ...
        Va.prototype = {
            addLabel: function() {
                ...
                r(d) ? d && d.attr({
                    text: b
                }) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(D(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
            },
            ...
            handleOverflow: function(a) {
                var b = this.axis,
                    ...
                    n,
                    q = {};
                if (h) h < 0 && c - i * k < f ? n = B(c / U(h * ha) - f) : h > 0 && c + i * k > e && (n = B((d - c) / U(h * ha)));
                else if (d = c + (1 - i) * k, c - i * k < f ? l = a.x + l * (1 - i) - f: d > e && (l = e - a.x + l * i, m = -1), l = E(j, l), l < j && b.labelAlign === "center" && (a.x += m * (j - l - i * (j - E(k, l)))), k > l || b.autoRotation && g.styles.width) n = l;
                if (n) {
                    q.width = n;
                    if (!b.options.labels.style.textOverflow) q.textOverflow = "ellipsis";
                    g.css(q)
                }
            },
            ...
            getLabelPosition: function(a, b, c, d, e, f, g, h) {
                var i = this.axis,
                    ...
                    n = e.y;
                r(n) || (n = i.side === 0 ? c.rotation ? -8 : -c.getBBox().height: i.side === 2 ? m.y + 8 : U(c.rotation * ha) * (m.y - c.getBBox(!1, 0).height / 2));
            ...
            render: function(a, b, c) {
                var d = this.axis,
                    ...
                    u = !0,
                    r = d.tickmarkOffset,
                    t = this.getPosition(g, k, r, b),
                    Y = t.x,
                    t = t.y,
                    s = g && Y === d.pos + d.len || !g && t === d.pos ? -1 : 1,
                    c = p(c, 1);
                this.isActive = !0;
                if (q) {
                ...
                if (m) d.opposite && (m[0] = -m[0]),
                    h = this.getMarkPath(Y, t, m[0], m[1] * s, g, f),
                    o ? o.animate({
                        d: h,
                        opacity: c
                ...
                if (i && !isNaN(Y)) i.xy = t = this.getLabelPosition(Y, t, i, g, j, r, a, x),
                    this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? u = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(t),
                x && a % x && (u = !1),
                    u && !isNaN(t.y) ? (t.opacity = c, i[this.isNew ? "attr": "animate"](t), this.isNew = !1) : i.attr("y", -9999)
            },
            destroy: function() {
                Ra(this, this.axis)
            }
        ...
        w.PlotLineOrBand.prototype = {
            render: function() {
                ...
                if (g) {
                    ...
                    if (v) x.fill = v;
                    if (d.borderWidth) x.stroke = d.borderColor,
                ...
                if (m) if (n) m.show(),
                ...
                } else if (n && n.length && (a.svgElem = m = u.path(n).attr(x).add(), o)) for (q in d = function(b) {
                    m.on(b,
                        function(c) {
                            o[b].apply(a, [c])
                        })
                    ...
                    o) d(q);
                e && r(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat ? (e = D({
                        align: c && k && "center",
                        x: c ? !k && 4 : 10,
            ...
            renderLabel: function(a, b, c, d) {
                ...
                if (!e) e = {
                    ...
                    e.zIndex = d,
                    this.label = e = f.text(a.text, 0, 0, a.useHTML).attr(e).css(a.style).add();
                d = [b[1], b[4], c ? b[6] : b[1]];
                b = [b[2], b[5], c ? b[7] : b[2]];
                c = Qa(d);
                f = Qa(b);
        ...
        fa.prototype = {
            ...
            init: function(a, b) {
                ...
                ra(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
                this.series = this.series || [];
                if (a.inverted && c && this.reversed === z) this.reversed = !0;
                this.removePlotLine = this.removePlotBand = this.removePlotBandOrLine;
                for (f in d) N(this, f, d[f]);
                if (this.isLog) this.val2lin = this.log2lin,
            ...
            defaultLabelFormatter: function() {
                ...
                else if (f && a >= 1E3) for (; f--&&g === z;) c = Math.pow(1E3, f + 1),
                a >= c && b * 10 % c === 0 && e[f] !== null && (g = w.numberFormat(b / c, -1) + e[f]);
                g === z && (g = Q(b) >= 1E4 ? w.numberFormat(b, -1) : w.numberFormat(b, -1, z, ""));
                return g
            },
                ...
                o(a.series,
                    function(c) {
                        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            a.isLog && e <= 0 && (e = null);
                            if (a.isXAxis) {
                                if (d = c.xData, d.length) a.dataMin = E(p(a.dataMin, d[0]), Qa(d)),
                                    a.dataMax = t(p(a.dataMax, d[0]), Fa(d))
                            } else {
                                c.getExtremes();
                                f = c.dataMax;
                                c = c.dataMin;
                                if (r(c) && r(f)) a.dataMin = E(p(a.dataMin, c), c),
                                    a.dataMax = t(p(a.dataMax, f), f);
            ...
            adjustForMinRange: function() {
                var a = this.options,
                    ...
                    f, g, h, i, k, j;
                if (this.isXAxis && this.minRange === z && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null: (o(this.series,
                    function(a) {
                        i = a.xData;
                        for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--) if (h = i[g] - i[g - 1], f === z || h < f) f = h
            ...
            getClosest: function() {
                ...
                o(this.series,
                    function(b) {
                        var c = b.closestPointRange; ! b.noSharedTooltip && r(c) && (a = r(a) ? E(a, c) : c)
                    });
                return a
            },
            setAxisTranslation: function(a) {
                var b = this,
                    ...
                    k = b.transA,
                    j = b.isXAxis;
                if (j || i || d) if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (e = b.getClosest(), o(b.series,
                        function(a) {
            ...
            setTickInterval: function(a) {
                var b = this,
                    ...
                    q = b.threshold,
                    v = b.softThreshold,
                    y, sa, x, u; ! g && !n && !i && this.getTickAmount();
                x = p(b.userMin, d.min);
                u = p(b.userMax, d.max);
                i ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && Z(11, 1)) : (!v && r(q) && (b.dataMin >= q ? (y = q, j = 0) : b.dataMax <= q && (sa = q, k = 0)), b.min = p(x, y, b.dataMin), b.max = p(u, sa, b.dataMax));
                if (e) ! a && E(b.min, p(b.dataMin, b.min)) <= 0 && Z(10, 1),
                    b.min = da(f(b.min), 15),
                    b.max = da(f(b.max), 15);
                if (b.range && r(b.max)) b.userMin = b.min = x = t(b.min, b.minFromRange()),
                    b.userMax = u = b.max,
                    b.range = null;
                b.beforePadding && b.beforePadding();
                b.adjustForMinRange();
                if (!n && !b.axisPointRange && !b.usePercentage && !i && r(b.min) && r(b.max) && (f = b.max - b.min)) ! r(x) && j && (b.min -= f * j),
                !r(u) && k && (b.max += f * k);
                if (ma(d.floor)) b.min = t(b.min, d.floor);
                if (ma(d.ceiling)) b.max = E(b.max, d.ceiling);
                if (v && r(b.dataMin)) if (q = q || 0, !r(x) && b.min < q && b.dataMin >= q) b.min = q;
                else if (!r(u) && b.max > q && b.dataMax <= q) b.max = q;
                ...
                if (!g && !e && !l) b.tickInterval = tb(b.tickInterval, null, sb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
            ...
            alignToOthers: function() {
                var a = {},
                    b, c = this.options;
                this.chart.options.chart.alignTicks !== !1 && c.alignTicks !== !1 && o(this.chart[this.coll],
                    function(c) {
                        var e = c.options,
            ...
            getTickAmount: function() {
                var a = this.options,
                    b = a.tickAmount,
                    c = a.tickPixelInterval; ! r(a.tickInterval) && this.len < c && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2); ! b && this.alignToOthers() && (b = ua(this.len / c) + 1);
                if (b < 4) this.finalTickAmt = b,
                    b = 5;
                this.tickAmount = b
            },
            ...
            tickSize: function(a) {
                ...
                if (d && c) return b[a + "Position"] === "inside" && (c = -c),
                    [c, d]
            },
            ...
            unsquish: function() {
                ...
                b ? (j = !a.staggerLines && !a.step && (r(g) ? [g] : e < p(a.autoRotationLimit, 80) && a.autoRotation)) && o(j,
                    function(a) {
                        var b;
                        if (a === g || a && a >= -90 && a <= 90) i = l(Q(h.h / aa(ha * a))),
                            b = i + Q(a / 360),
                        b < k && (k = b, f = a, d = i)
                    }) : a.step || (d = l(h.h));
                this.autoRotation = j;
            ...
            renderUnsquish: function() {
                ...
                if (this.autoRotation) o(c,
                    ...
                    m > h && m > k.h ? i.rotation = this.labelRotation: this.labelRotation = 0;
                        ...
                        !j)) {
                    l.textOverflow = "clip";
                    for (n = c.length; ! f && n--;) if (q = c[n], h = d[q].label) if (h.styles.textOverflow === "ellipsis" ? h.css({
                            textOverflow: "clip"
            ...
            getOffset: function() {
                ...
                if (!a.axisGroup) a.gridGroup = c.g("grid").attr({
                    ...
                    a.labelGroup = c.g("axis-labels").attr({
                        zIndex: v.zIndex || 7
                    }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(z);
                if (k || a.isLinked) {
                    if (o(e,
                            function(b) {
                                f[b] ? f[b].addLabel() : f[b] = new Va(a, b)
                            }), a.renderUnsquish(), v.reserveSpace !== !1 && (h === 0 || h === 2 || {
                            1 : "left",
                            3 : "right"
                        } [h] === a.labelAlign || a.labelAlign === "center") && o(e,
                            function(a) {
                                y = t(f[a].getLabelSize(), y)
                            }), a.staggerLines) y *= a.staggerLines,
                        a.labelOffset = y * (a.opposite ? -1 : 1)
                ...
                if (q && q.text && q.enabled !== !1) {
                    if (!a.axisTitle) a.axisTitle = c.text(q.text, 0, 0, q.useHTML).attr({
                        ...
                        a.axisTitle.isNew = !0;
                    if (j) l = a.axisTitle.getBBox()[g ? "height": "width"],
                        m = q.offset,
                        n = r(m) ? 0 : p(q.margin, g ? 5 : 10);
                ...
                x[h] = t(x[h], a.axisTitleMargin + l + u * a.offset, n, k && e.length && Y ? Y[0] : 0);
            ...
            render: function() {
                var a = this,
                    ...
                    q = a.tickmarkOffset,
                    v = d.lineWidth,
                    p, sa = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin),
                    x = a.showAxis,
                    u = $a(c.globalAnimation),
                    t,
                    s;
                ...
                if (a.hasData() || g) {
                    a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(),
                        function(b) {
                    ...
                    if (h.length && (o(h,
                            function(b, c) {
                                if (!g || b >= a.min && b <= a.max) k[b] || (k[b] = new Va(a, b)),
                                sa && k[b].isNew && k[b].render(c, !0, 0.1),
                                    k[b].render(c)
                            }), q && (a.min === 0 || a.single))) k[ - 1] || (k[ - 1] = new Va(a, -1, null, !0)),
                        k[ - 1].render( - 1);
                    n && o(h,
                        function(c, d) {
                            s = h[d + 1] !== z ? h[d + 1] + q: a.max - q;
                            if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -q: q)) l[c] || (l[c] = new w.PlotLineOrBand(a)),
                                t = c + q,
                                l[c].options = {
                                    from: e ? f(t) : t,
                                    to: e ? f(s) : s,
                    ...
                    if (!a._addedPlotLB) o((d.plotLines || []).concat(d.plotBands || []),
                        function(b) {
                ...
                if (v) p = a.getLinePath(v),
                    ...
                    a.axisLine[x ? "show": "hide"](!0);
                if (i && x) i[i.isNew ? "attr": "animate"](a.getTitlePosition()),
                    i.isNew = !1;
                m && m.enabled && a.renderStackTotals();
                a.isDirty = !1
            },
            redraw: function() {
                this.visible && (this.render(), o(this.plotLinesAndBands,
                    function(a) {
                        a.render()
                    }));
                o(this.series,
            ...
            destroy: function(a) {
                ...
                for (d in c) Ra(c[d]),
                    c[d] = null;
                o([b.ticks, b.minorTicks, b.alternateBands],
                    function(a) {
                        Ra(a)
                    });
            ...
            drawCrosshair: function(a, b) {
                var c, d = this.crosshair,
                    e, f;
                if (!this.crosshair || (r(b) || !p(d.snap, !0)) === !1) this.hideCrosshair();
        ...
        s(fa.prototype, {
            ...
            addPlotBandOrLine: function(a, b) {
                var c = (new w.PlotLineOrBand(this, a)).render(),
                    d = this.userOptions;
            ...
            removePlotBandOrLine: function(a) {
                ...
                o([c.plotLines || [], d.plotLines || [], c.plotBands || [], d.plotBands || []],
                    function(b) {
                        for (e = b.length; e--;) b[e].id === a && na(b, b[e])
                    })
            }
        });
        fa.prototype.getTimeTicks = function(a, b, c, d) {
            ...
            if (r(b)) {
                ...
                if (k >= G.second) i[Gb](k >= G.minute ? 0 : j * T(i.getSeconds() / j));
                if (k >= G.minute) i[Hb](k >= G.hour ? 0 : j * T(i[ub]() / j));
                if (k >= G.hour) i[Ib](k >= G.day ? 0 : j * T(i[vb]() / j));
                if (k >= G.day) i[kb](k >= G.month ? 1 : j * T(i[Ua]() / j));
                k >= G.month && (i[xb](k >= G.year ? 0 : j * T(i[ab]() / j)), h = i[bb]());
                k >= G.year && (h -= h % j, i[yb](h));
                if (k === G.week) i[kb](i[Ua]() - i[wb]() + p(d, 1));
                b = 1;
                if (rb || Za) i = i.getTime(),
                    i = new pa(i + Ya(i));
                h = i[bb]();
                for (var d = i.getTime(), l = i[ab](), m = i[Ua](), n = !g || !!Za, q = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c;) e.push(d),
                    k === G.year ? d = jb(h + b * j, 0) : k === G.month ? d = jb(h, l + b * j) : n && (k === G.day || k === G.week) ? d = jb(h, l, m + b * j * (k === G.day ? 1 : 7)) : d += k * j,
                    b++;
                e.push(d);
                o(Ma(e,
                    function(a) {
        ...
        fa.prototype.getLogTickPositions = function(a, b, c, d) {
            ...
            if (a >= 0.5) a = B(a),
                i = this.getLinearTickPositions(a, b, c);
            else if (a >= 0.08) for (var f = T(b), k, j, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
                j = e.length;
                for (k = 0; k < j && !n; k++) l = h(g(f) * e[k]),
                l > b && (!d || m <= c) && m !== z && i.push(m),
                m > c && (n = !0),
                    m = l
            } else if (b = g(b), c = g(c), a = e[d ? "minorTickInterval": "tickInterval"], a = p(a === "auto" ? null: a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length: f) || 1)), a = tb(a, null, sb(a)), i = Ba(this.getLinearTickPositions(a, b, c), h), !d) this._minorAutoInterval = a / 5;
        ...
        Ob.prototype = {
            ...
            getPosition: function(a, b, c) {
                var d = this.chart,
                    ...
                    j = !this.followPointer && p(c.ttBelow, !d.inverted === !!c.negative),
                    l = function(a, b, c, d, h, i) {
                        ...
                        else if (k) f[a] = E(i - c, l - g < 0 ? l: l - g);
            ...
            refresh: function(a, b) {
                ...
                f = h[0];
                g = h[1];
                m && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, i && o(i,
                    function(a) {
                        a.setState()
                    }), o(a,
                    function(a) {
                ...
                k === !1 ? this.hide() : (this.isHidden && (Na(d), d.attr("opacity", 1).show()), d.attr({
                    text: k
            ...
            getXDateFormat: function(a, b, c) {
                ...
                if (e) {
                    ...
                    for (f in G) {
                        if (e === G.week && +Pa("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                            f = "week";
                            break
                        }
                        if (G[f] > e) {
        ...
        Xa.prototype = {
            init: function(a, b) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                if (w.Tooltip && b.tooltip.enabled) a.tooltip = new Ob(a, b.tooltip),
            ...
            runPointActions: function(a) {
                ...
                g && (e ? g.noSharedTooltip: g.directTouch) && f ? m = [f] : (o(c,
                    function(b) {
                        ...
                        j = !e && b.directTouch;
                        b.visible && !k && !j && p(b.options.enableMouseTracking, !0) && (n = b.searchPoint(a, !k && b.kdDimensions === 1)) && l.push(n)
                    }), o(l,
                    function(a) {
                        a && o(["dist", "distX"],
                            function(b, c) {
                                if (typeof a[b] === "number") {
                                    ...
                                    if (a[b] < i[c] || d) i[c] = a[b],
                                        m[c] = a
                                }
                            })
                    }));
                if (e) for (h = l.length; h--;)(l[h].clientX !== m[1].clientX || l[h].series.noSharedTooltip) && l.splice(h, 1);
                if (m[0] && (m[0] !== this.prevKDPoint || d && d.isHidden)) if (e && !m[0].series.noSharedTooltip) l.length && d && d.refresh(l, a),
                    o(l,
                        function(b) {
                ...
                if (!this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                    if (O[ga]) O[ga].pointer.onDocumentMouseMove(a)
                },
                    N(A, "mousemove", this._onDocumentMouseMove);
                o(e ? l: [p(m[1], f)],
                    function(c) {
                        o(b.axes,
                            function(b) { (!c || c.series[b.coll] === b) && b.drawCrosshair(a, c)
                            })
                    })
            },
            reset: function(a, b) {
                ...
                if (a) g && h && (g.refresh(h), e && (e.setState(e.state, !0), o(c.axes,
                    function(a) {
                        p(a.crosshair && a.crosshair.snap, !0) ? a.drawCrosshair(null, e) : a.hideCrosshair()
                    })));
                else {
                    if (e) e.onMouseOut();
                    f && o(f,
                    ...
                    if (d) d.onMouseOut();
                    g && g.hide(b);
                    if (this._onDocumentMouseMove) V(A, "mousemove", this._onDocumentMouseMove),
            ...
            drag: function(a) {
                ...
                if (!m || !m.touch) if (d < h ? d = h: d > h + k && (d = h + k), e < i ? e = i: e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(q - e, 2)), this.hasDragged > 10) {
                    l = b.isInsidePlot(n - h, q - i);
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !v && !m) this.selectionMarker = m = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
            ...
            onContainerMouseMove: function(a) {
                var b = this.chart;
                if (!r(ga) || !O[ga] || !O[ga].mouseIsDown) ga = b.index;
                a = this.normalize(a);
                a.returnValue = !1;
            ...
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    e = b.plotTop,
                    a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (H(c.series, "click", s(a, {
                    point: c
                })), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && H(b, "click", a)))
            },
            ...
            destroy: function() {
                ...
                eb || (V(A, "mouseup", this.onDocumentMouseUp), V(A, "touchend", this.onDocumentTouchEnd));
        ...
        s(w.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
                var i = this.chart,
                    ...
                    z = !u && c[1][l],
                    w,
                    c = function() { ! u && Q(t - s) > 20 && (p = h || Q(r - z) / Q(t - s));
                        v = (n - r) / p + t;
                        q = i["plot" + (a ? "Width": "Height")] / p
                    };
                c();
                b = v;
                b < x.min ? (b = x.min, w = !0) : b + q > x.max && (b = x.max - q, w = !0);
                w ? (r -= 0.8 * (r - g[k][0]), u || (z -= 0.8 * (z - g[k][1])), c()) : g[k] = [r, z];
                o || (f[k] = v - n, f[m] = q);
                f = o ? 1 / p: p;
                e[m] = q;
                e[k] = b;
            ...
            touch: function(a, b) {
                ...
                if (a.touches.length === 1) if (a = this.normalize(a), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu) {
                    ...
                    if (a.type === "touchmove") c = this.pinchDown,
                        d = Math.sqrt(Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY - a.chartY, 2)) >= 4;
                    p(d, !0) && this.pinch(a)
                } else b && this.reset();
        ...
        if (C.PointerEvent || C.MSPointerEvent) {
            var va = {},
                ...
                Db = function(a, b, c, d) {
                    if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && O[ga]) d(a),
                        d = O[ga].pointer,
                        d[b]({
                            type: c,
            ...
            s(Xa.prototype, {
                onContainerPointerDown: function(a) {
                    Db(a, "onContainerTouchStart", "touchstart",
                        function(a) {
                            va[a.pointerId] = {
                                pageX: a.pageX,
                                pageY: a.pageY,
                ...
                onContainerPointerMove: function(a) {
                    Db(a, "onContainerTouchMove", "touchmove",
                        function(a) {
                            va[a.pointerId] = {
                                pageX: a.pageX,
                                pageY: a.pageY
                ...
                onDocumentPointerUp: function(a) {
                    Db(a, "onDocumentTouchEnd", "touchend",
                        function(a) {
        ...
        pb.prototype = {
            ...
            positionItem: function(a) {
                var b = this.options,
                    ...
                    e = d[0],
                    d = d[1],
                    f = a.checkbox; (a = a.legendGroup) && a.element && a.translate(b ? e: this.legendWidth - e - 2 * c - 4, d);
                if (f) f.x = e,
                    f.y = d
            },
            ...
            renderItem: function(a) {
                ...
                if (!o) {
                    ...
                    a.legendItem = o = c.text("", l ? f + g: -g, this.baseline || 0, u).css(D(a.visible ? h: i)).attr({
                        align: l ? "left": "right",
                        zIndex: 2
                    }).add(a.legendGroup);
                ...
                if (e && this.itemX - v + f > (m || b.chartWidth - 2 * k - v - d.x)) this.itemX = v,
                ...
                this.offsetWidth = m || t((e ? this.itemX - v - j: f) + k, this.offsetWidth)
            },
            getAllItems: function() {
                ...
                o(this.chart.series,
                    function(b) {
                        var c = b.options;
                        if (p(c.showInLegend, !r(c.linkedTo) ? z: !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data: b))
                    });
                return a
            },
            adjustMargins: function(a, b) {
                ...
                this.display && !d.floating && o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/],
                    function(f, g) {
                        f.test(e) && !r(a[g]) && (c[nb[g]] = t(c[nb[g]], c.legend[(g + 1) % 2 ? "legendHeight": "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x": "y"] + p(d.margin, 12) + b[g]))
                    })
            },
            render: function() {
                var a = this,
                    ...
                    o(y,
                        function(a, b) {
                            var c = a._legendItemPos[1],
                                ...
                                e = n.length;
                            if (!e || c - n[e - 1] > h && (v || c) !== n[e - 1]) n.push(v || c),
                                e++;
        ...
        M = w.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                if (c && c.enabled !== !1) b = c.radius,
                    this.legendSymbol = c = e.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b, c).add(f),
                    c.isMarker = !0
            }
        }; (/Trident\/7\.0/.test(za) || La) && fb(pb.prototype, "positionItem",
            function(a, b) {
                var c = this,
                    d = function() {
        ...
        gb.prototype = {
            ...
            initSeries: function(a) {
                var b = this.options.chart; (b = I[a.type || b.type || b.defaultSeriesType]) || Z(17, !0);
                b = new b;
                b.init(this, a);
                return b
            },
                ...
                i && (o(b,
                    ...
                    function(a) {
                        ...
                        if (a.extKey !== b) a.extKey = b,
                            q.push(function() {
                                H(a, "afterSetExtremes", s(a.eventArgs, a.getExtremes()));
                                delete a.eventArgs
                            }); (k || g) && a.redraw()
                    }));
                k && this.drawChartBox();
            ...
            getChartSize: function() {
                ...
                if (!r(b)) this.containerWidth = ka(c, "width");
                if (!r(a)) this.containerHeight = ka(c, "height");
            ...
            cloneRenderTo: function(a) {
                var b = this.renderToClone,
                    c = this.container;
                a ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), L(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
            ...
            getContainer: function() {
                ...
                a || Z(13, !0);
                d = F(K(a, "data-highcharts-chart")); ! isNaN(d) && O[d] && O[d].hasRendered && O[d].destroy();
                K(a, "data-highcharts-chart", this.index);
                a.innerHTML = ""; ! c.skipClone && !a.offsetWidth && this.cloneRenderTo();
                this.getChartSize();
                d = this.chartWidth;
                e = this.chartHeight;
                this.container = a = $(Ka, {
                ...
                this.renderer = new(w[c.renderer] || cb)(a, d, e, c.style, c.forExport, b.exporting && b.exporting.allowHTML);
            ...
            setSize: function(a, b, c) {
                ...
                if (r(a)) d.chartWidth = e = t(0, B(a)),
                    d.hasUserSize = !!e;
                if (r(b)) d.chartHeight = f = t(0, B(b));
                a = g.globalAnimation; (a ? Wa: L)(d.container, {
                        width: e + "px",
                        height: f + "px"
                    },
                    a);
            ...
            drawChartBox: function() {
                ...
                if (j) f ? f.animate(x) : this.plotBackground = b.rect(q, p, o, r, 0).attr({
                    fill: j
                }).add().shadow(a.plotShadow);
                if (l) h ? h.animate(x) : this.plotBGImage = b.image(l, q, p, o, r).add();
                u ? u.animate({
                    width: t.width,
                    height: t.height
                ...
                if (m) g ? (g.strokeWidth = -m, g.animate(g.crisp({
                    ...
                    width: o,
                    height: r
                }))) : this.plotBorder = b.rect(q, p, o, r, 0, -m).attr({
            ...
            linkSeries: function() {
                ...
                o(b,
                    function(b) {
                        ...
                        if (xa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b),
                            b.linkedParent = d,
            ...
            isReadyToRender: function() {
                var a = this;
                return ! ca && C == C.top && A.readyState !== "complete" || ia && !C.canvg ? (ia ? Nb.push(function() {
                        a.firstRender()
                    },
            ...
            firstRender: function() {
                ...
                if (a.isReadyToRender()) {
                    ...
                    a.linkSeries();
                    H(a, "beforeRender");
                    if (w.Pointer) a.pointer = new Xa(a, b);
                    a.render();
                    a.renderer.draw();
            ...
            onload: function() {
                var a = this;
                o([this.callback].concat(this.callbacks),
                    function(b) {
        ...
        Ia.prototype = {
            ...
            destroy: function() {
                var a = this.series.chart,
                    ...
                    c;
                a.pointCount--;
                if (b && (this.setState(), na(b, this), !b.length)) a.hoverPoints = null;
                if (this === a.hoverPoint) this.onMouseOut();
                if (this.graphic || this.dataLabel) V(this),
                    this.destroyElements();
                this.legendItem && a.legend.destroyItem(this);
                for (c in this) this[c] = null
            },
            destroyElements: function() {
                for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, c = 6; c--;) b = a[c],
        ...
        R.prototype = {
                ...
                o(a.axisTypes || [],
                    function(e) {
                        o(c[e],
                            function(c) {
                                d = c.options;
                                if (b[e] === d.index || b[e] !== z && b[e] === d.id || b[e] === z && d.index === 0) c.series.push(a),
                                    a[e] = c,
                                    c.isDirty = !0
            ...
            updateParallelArrays: function(a, b) {
                var c = a.series,
                    d = arguments;
                o(c.parallelArrays, typeof b === "number" ?
                    function(d) {
            ...
            autoIncrement: function() {
                ...
                d && (a = new pa(b), d === "day" ? a = +a[kb](a[Ua]() + c) : d === "month" ? a = +a[xb](a[ab]() + c) : d === "year" && (a = +a[yb](a[bb]() + c)), c = a - b);
                this.xIncrement = b + c;
                return b
            },
            setOptions: function(a) {
            ...
            setData: function(a, b, c, d) {
                var e = this,
                    ...
                    q = this.xData,
                    v = this.yData,
                    y = (h = e.pointArrayMap) && h.length,
                    a = a || [];
                h = a.length;
                b = p(b, !0);
                if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a,
                    function(a, b) {
                    ...
                    if (n && h > n) {
                        ...
                        if (ma(j)) {
                            ...
                            for (c = 0; c < h; c++) q[c] = m,
                                ...
                                m += j;
                            e.xIncrement = m
                        } else if (Da(j)) if (y) for (c = 0; c < h; c++) j = a[c],
                            q[c] = j[0],
                            v[c] = j.slice(1, y + 1);
                        else for (c = 0; c < h; c++) j = a[c],
                                q[c] = j[0],
                                v[c] = j[1];
                        else Z(12)
                    } else for (c = 0; c < h; c++) if (a[c] !== z && (j = {
                            series: e
                        },
                            e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j, c), m && r(j.name))) l.names[j.x] = j.name;
                    xa(v[0]) && Z(14, !0);
                    e.data = [];
            ...
            processData: function(a) {
                ...
                if (h) a = h.getExtremes(),
                    n = a.min,
                    q = a.max;
                if (l && this.sorted && !j && (!i || d > i || this.forceCrop)) if (b[d - 1] < n || b[0] > q) b = [],
                    c = [];
                else if (b[0] < n || b[d - 1] > q) e = this.cropData(this.xData, this.yData, n, q),
                    b = e.xData,
                    c = e.yData,
                    e = e.start,
                    f = !0;
                for (i = b.length || 1; --i;) d = m ? k(b[i]) - k(b[i - 1]) : b[i] - b[i - 1],
                    d > 0 && (g === z || d < g) ? g = d: d < 0 && this.requireSorting && Z(15);
                this.cropped = f;
                this.cropStart = e;
            ...
            generatePoints: function() {
                ...
                if (!b && !k) b = [],
                    ...
                    b = this.data = b;
                for (m = 0; m < g; m++) i = h + m,
                    k ? (l[m] = (new f).init(this, [d[m]].concat(ta(e[m]))), l[m].dataGroup = this.groupMap[m]) : (b[i] ? j = b[i] : a[i] !== z && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j),
                    l[m].index = i;
            ...
            getExtremes: function(a) {
                ...
                d = a.length;
                for (l = 0; l < d; l++) if (k = c[l], j = a[l], i = j !== null && j !== z && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k) if (i = j.length) for (; i--;) j[i] !== null && (e[f++] = j[i]);
                else e[f++] = j;
                this.dataMin = Qa(e);
                this.dataMax = Fa(e)
            },
            translate: function() {
                ...
                for (var a = this.options,
                         ...
                         h = !!this.modifyValue,
                         i = a.pointPlacement,
                         k = i === "between" || ma(i), j = a.threshold, l = a.startFromThreshold ? j: 0, m, n, q, o, y = Number.MAX_VALUE, a = 0; a < g; a++) {
                    var s = f[a],
                        x = s.x,
                        u = s.y;
                    n = s.low;
                    var w = b && e.stacks[(this.negStacks && u < (l ? 0 : j) ? "-": "") + this.stackKey];
                    if (e.isLog && u !== null && u <= 0) s.y = u = null,
                        Z(10);
                    s.plotX = m = E(t( - 1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                    if (b && this.visible && !s.isNull && w && w[x]) o = this.getStackIndicator(o, x, this.index),
                        w = w[x],
                        u = w.points[o.key],
                        n = u[0],
                        u = u[1],
                    n === l && (n = p(j, e.min)),
                    e.isLog && n <= 0 && (n = null),
                        s.total = s.stackTotal = w.total,
                        s.percentage = w.total && s.y / w.total * 100,
                        s.stackY = u,
                        w.setOffset(this.pointXOffset || 0, this.barW || 0);
                    s.yBottom = r(n) ? e.translate(n, 0, 1, 0, 1) : null;
                    h && (u = this.modifyValue(u, s));
                    s.plotY = n = typeof u === "number" && u !== Infinity ? E(t( - 1E5, e.translate(u, 0, 1, 0, 1)), 1E5) : z;
                    s.isInside = n !== z && n >= 0 && n <= e.len && m >= 0 && m <= c.len;
            ...
            setClip: function(a) {
                ...
                a && (i.count += 1);
                if (c.clip !== !1) this.group.clip(a || f ? i: b.clipRect),
            ...
            animate: function(a) {
                var b = this.chart,
                    ...
                    d;
                if (c && !X(c)) c = ba[this.type].animation;
            ...
            drawPoints: function() {
                var a, b = this.points,
                    ...
                    o,
                    y = this.markerGroup,
                    r = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
                if (l.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {},
                        q = !!g.marker, a = r && n.enabled === z || n.enabled, o = g.isInside, a && e !== z && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || m, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j) j[o ? "show": "hide"](!0).attr(a).animate(s({
                        x: d - h,
                        y: e - h
                    },
                    j.symbolName ? {
                    ...
                    if (o && (h > 0 || k)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? n: l).attr(a).add(y)
            ...
            getAttribs: function() {
                ...
                if (!j || g < j || k) for (; g--;) {
                    ...
                    if (v.length) {
                        k = 0;
                        for (f = v[k]; j[y] >= f.value;) f = v[++k];
                        j.color = j.fillColor = p(f.color, a.color)
                    }
                    k = b.colorByPoint || j.color;
                    if (j.options) for (t in m) r(c[m[t]]) && (k = !0);
                    if (k) {
                        c = c || {};
                        k = [];
                        d = c.states || {};
                        f = d.hover = d.hover || {};
                        if (!b.marker || j.negative && !f.fillColor && !e.fillColor) f[a.pointAttrToOptions.fill] = f.color || !j.options.color && e[j.negative && h ? "negativeColor": "color"] || ja(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
            ...
            getGraphPath: function(a, b, c) {
                var d = this,
                    ...
                    g, h = [],
                    i,
                    a = a || d.points; (g = a.reversed) && a.reverse(); (f = {
                        right: 1,
                        center: 2
                    } [f] || f && 3) && g && (f = 4 - f);
                ...
                o(c,
                    function(c, i) {
                        ...
                        if (j) j.animate({
                            ...
                            a[k] = a.chart.renderer.path(f).attr(j).add(a.group).shadow(i < 2 && b.shadow)
                    })
            },
            applyZones: function() {
                var a = this,
                    ...
                    x,
                    u = !1;
                if (d.length && (i || k) && l.min !== z) i && i.hide(),
                k && k.hide(),
                    m = l.getExtremes(),
                    o(d,
                        function(d, o) {
                            e = n ? v ? b.plotWidth: 0 : v ? 0 : l.toPixels(m.min);
                            e = E(t(p(f, e), 0), j);
            ...
            redraw: function() {
                ...
                this.translate();
                this.render();
                b && H(this, "updatedData"); (c || b) && delete this.kdTree
            },
            kdDimensions: 1,
            ...
            buildKDTree: function() {
                function a(c, e, f) {
                    var g, h;
                    if (h = c && c.length) return g = b.kdAxisArray[e % f],
                        c.sort(function(a, b) {
                            return a[g] - b[g]
                        }),
                        h = Math.floor(h / 2),
        ...
        fa.prototype.buildStacks = function() {
            ...
            if (!this.isXAxis) {
                ...
                for (e = d; e--;) b = a[c ? e: d - e - 1],
                b.setStackCliffs && b.setStackCliffs();
        ...
        R.prototype.setStackedPoints = function() {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                ...
                for (x = 0; x < d; x++) {
                    ...
                    y = (o = j && s < (g ? 0 : f)) ? k: i;
                    m[y] || (m[y] = {});
                    if (!m[y][u]) n[y] && n[y][u] ? (m[y][u] = n[y][u], m[y][u].total = null) : m[y][u] = new Jb(l, l.options.stackLabels, o, u, h);
                    y = m[y][u];
                    if (s !== null) y.points[r] = y.points[this.index] = [p(y.cum, g)],
                        y.touched = l.stacksTouched,
                    q.index > 0 && this.singleStacks === !1 && (y.points[r][0] = y.points[this.index + "," + u + ",0"][0]);
                    e === "percent" ? (o = o ? i: k, j && m[o] && m[o][u] ? (o = m[o][u], y.total = o.total = t(o.total, y.total) + Q(s) || 0) : y.total = da(y.total + (Q(s) || 0))) : y.total = da(y.total + (s || 0));
                    y.cum = p(y.cum, g) + (s || 0);
                    if (s !== null) y.points[r].push(y.cum),
                        c[x] = y.cum
                }
        ...
        R.prototype.setPercentStacks = function() {
            ...
            o([b, "-" + b],
                function(b) {
                    var f;
                    for (var g = d.length,
                             h, i; g--;) if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total: 0,
                        h[0] = da(h[0] * i),
                        h[1] = da(h[1] * i),
                        a.stackedYData[g] = h[1]
                })
        };
        R.prototype.getStackIndicator = function(a, b, c) { ! r(a) || a.x !== b ? a = {
            x: b,
            index: 0
        }: a.index++;
        ...
        s(R.prototype, {
            addPoint: function(a, b, c, d) {
                ...
                m = i.x;
                d = q.length;
                if (e.requireSorting && m < q[d - 1]) for (n = !0; d && q[d - 1] > m;) d--;
        ...
        var la = oa(R, {
                            ...
                            if (f[g] && !f[g].isNull) a.push(f[g]),
                                o([ - 1, 1],
                                    function(a) {
                                        ...
                                        p || (m === h ? f[g][c] = !0 : j[m] && (r = e[g].points[m]) && (d -= r[1] - r[0])),
                                            m += l;
            ...
            getGraphPath: function(a) {
                ...
                for (f = 0; f < a.length; f++) if (g = a[f].isNull, j = p(a[f].rectPlotX, a[f].plotX), q = p(a[f].yBottom, n), !g || c) {
                    c || o(f, f - 1, "left");
                    if (!g || d || !c) i.push(a[f]),
                        h.push({
                            x: f,
            ...
            drawGraph: function() {
                ...
                o(d,
                    function(d) {
                        ...
                        d[2] || (g["fill-opacity"] = p(c.fillOpacity, 0.75)), a[f] = a.chart.renderer.path(b).attr(g).add(a.group))
                    })
            },
        ...
        wa = oa(R, {
            ...
            getPointSpline: function(a, b, c) {
                ...
                if (f && !f.isNull && c && !c.isNull) {
                    ...
                    h += j;
                    k += j;
                    h > a && h > e ? (h = t(a, e), k = 2 * e - h) : h < a && h < e && (h = E(a, e), k = 2 * e - h);
                    k > c && k > e ? (k = t(c, e), h = 2 * e - k) : k < c && k < e && (k = E(c, e), h = 2 * e - k);
                    b.rightContX = i;
                    b.rightContY = k
                }
        ...
        wa = oa(R, {
            ...
            getColumnMetrics: function() {
                var a = this,
                    ...
                    f, g = {},
                    h = 0;
                b.grouping === !1 ? h = 1 : o(a.chart.series,
                    function(b) {
                        var c = b.options,
                            e = b.yAxis,
                            i;
                        if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === z && (g[f] = h++), i = g[f]) : c.grouping !== !1 && (i = h++),
                            b.columnIndex = i
                    });
                var i = E(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                    k = i * b.groupPadding,
                    j = (i - 2 * k) / h,
                ...
                o(a.points,
                    function(c) {
                        var d = E(p(c.yBottom, f), 9E4),
                            ...
                            w,
                            x = t(h, d) - s;
                        Q(x) < g && g && (x = g, w = !e.reversed && !c.negative || e.reversed && c.negative, s = Q(s - f) > g ? d - g: f - (w ? g: 0));
                        c.barX = o;
                        c.pointWidth = i;
                        c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - o - r / 2, x] : [o + r / 2, h + e.pos - b.plotTop, x];
                        c.shapeType = "rect";
                ...
                o(a.points,
                    function(h) {
                        ...
                        if (i !== z && !isNaN(i) && h.y !== null) f = h.shapeArgs,
                            ...
                            k ? (Na(k), k.attr(i).attr(g)[b.pointCount < e ? "animate": "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
            ...
            animate: function(a) {
                var b = this,
                    ...
                    e = this.chart.inverted,
                    f = {};
                if (ca) a ? (f.scaleY = 0.001, a = E(c.pos + c.len, t(c.pos, c.toPixels(d.threshold))), e ? f.translateX = a - c.len: f.translateY = a, b.group.attr(f)) : (f[e ? "translateX": "translateY"] = c.pos, b.group.animate(f, s($a(b.options.animation), {
                    step: function(a, c) {
                        b.group.attr({
                            scaleY: c.pos
                        })
        ...
        ea = {
            ...
            pointClass: oa(Ia, {
                ...
                setVisible: function(a, b) {
                    ...
                    if (a !== c.visible) {
                        ...
                        c.legendItem && e.legend.colorizeItem(c, a); ! a && c.state === "hover" && c.setState("");
                        if (f) d.isDirty = !0;
                        b && e.redraw()
                    }
                },
            ...
            translate: function(a) {
                ...
                var b = 0,
                    ...
                    k = this.startAngleRad = qa / 180 * (i - 90),
                    i = (this.endAngleRad = qa / 180 * (p(c.endAngle, i + 360) - 90)) - k,
                    j = this.points,
                ...
                for (m = 0; m < n; m++) {
                    ...
                    o.angle = h;
                    e = E(e, l / 2);
                    o.labelPos = [a[0] + f + U(h) * l, a[1] + g + aa(h) * l, a[0] + f + U(h) * e, a[1] + g + aa(h) * e, a[0] + f, a[1] + g, l < 0 ? "center": o.half ? "right": "left", h]
                }
            },
            drawGraph: null,
            drawPoints: function() {
                ...
                o(a.points,
                    function(k) {
                        if (k.y !== null) {
                            ...
                            f && f.attr(c);
                            if (d) d.setRadialReference(a.center).attr(g).animate(s(h, c));
                            else {
                                i = {
                                    "stroke-linejoin": "round"
                                };
        ...
        R.prototype.drawDataLabels = function() {
            ...
            if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d),
                k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden": "visible", d.zIndex || 6),
            j && (k.attr({
                opacity: +h
            }), h || N(a, "afterAnimate",
                function() {
                    ...
                    function(e) {
                        ...
                        if (j && !h) e.dataLabel = j.destroy();
                            ...
                            if (j) if (r(i)) j.attr({
                                ...
                                if (e.dataLabel = j = j.destroy(), w) e.connector = w.destroy()
                            } else if (r(i)) {
                                j = {
                                ...
                                if (u.color === "contrast") B.color = d.inside || d.distance < 0 || b.stacking ? l.getContrast(e.color || a.color) : "#000000";
                                if (c) B.cursor = c;
                                for (t in j) j[t] === z && delete j[t];
                                j = e.dataLabel = l[h ? "text": "label"](i, 0, -9999, d.shape, null, null, d.useHTML).attr(j).css(s(u, B)).add(k).shadow(d.shadow)
                            }
            ...
            if (n) d = s({
                ...
                l ? (o = !1, g = f.renderer.rotCorr(j, l), g = {
                    ...
                    b[e ? "attr": "animate"](g).attr({
                        align: c.align
                    }), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? k.height: 0 : m === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : m === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr),
                o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)),
            c.shape && !l && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
            });
        ...
        if (I.pie) I.pie.prototype.drawDataLabels = function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                o(b,
                    function(a) {
                        if (a.dataLabel && a.visible) z[a.half].push(a),
                ...
                for (F = 2; F--;) {
                    ...
                    if (M) {
                        ...
                        for (J = b = 0; ! b && I[J];) b = I[J] && I[J].dataLabel && (I[J].dataLabel.getBBox().height || 21),
                            J++;
                        if (m > 0) {
                            x = E(r + q + m, d.plotHeight);
                            for (J = t(0, r - q - m); J <= x; J += b) H.push(J);
                            x = H.length;
                            if (M > x) {
                                c = [].concat(I);
                                c.sort(L);
                                for (J = M; J--;) c[J].rank = J;
                                for (J = M; J--;) I[J].rank >= x && I.splice(J, 1);
                                M = I.length
                            }
                            for (J = 0; J < M; J++) {
                                c = I[J];
                                ...
                                c = 9999;
                                var P, O;
                                for (O = 0; O < x; O++) P = Q(H[O] - u[1]),
                                P < c && (c = P, K = O);
                                if (K < J && H[J] !== null) K = J;
                                else for (x < M - J + K && H[J] !== null && (K = x - M + J); H[K] === null;) K++;
                                N.push({
                                    i: K,
                                    y: H[K]
                                });
                        ...
                        for (J = 0; J < M; J++) {
                            ...
                            c = u[1];
                            if (m > 0) {
                                if (x = N.pop(), K = x.i, C = x.y, c > C && H[K + 1] !== null || c < C && H[K - 1] !== null) C = E(t(0, c), d.plotHeight)
                            } else C = c;
                            A = e.justify ? n[0] + (F ? -1 : 1) * (q + m) : a.getX(C === r - q - m || C === r + q + m ? c: C, F);
                            w._attr = {
                                visibility: D,
                                align: u[6]
                            };
                            ...
                            w.connX = A;
                            w.connY = C;
                            if (this.options.size === null) x = w.width,
                                A - x < f ? G[3] = t(B(x - A + f), G[3]) : A + x > h - f && (G[1] = t(B(A + x - h + f), G[1])),
                                C - b / 2 < 0 ? G[0] = t(B( - C + b / 2), G[0]) : C + b / 2 > i && (G[2] = t(B(C + b / 2 - i), G[2]))
                        }
                    }
                }
                ...
                s && g && o(this.points,
                    function(b) {
                        k = b.connector;
                        u = b.labelPos;
                        if ((w = b.dataLabel) && w._pos && b.visible) D = w._attr.visibility,
                            A = w.connX,
                            C = w.connY,
                            j = l ? ["M", A + (u[6] === "left" ? 5 : -5), C, "C", A, C, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), C, "L", u[2], u[3], "L", u[4], u[5]],
                            k ? (k.animate({
                                d: j
            ...
            I.pie.prototype.alignDataLabel = Aa,
        ...
        if (I.column) I.column.prototype.alignDataLabel = function(a, b, c, d, e) {
                    ...
                    c(a.series,
                        function(a) {
                            var b = a.options.dataLabels,
                                f = a.dataLabelCollections || ["dataLabel"]; (b.enabled || a._hasPointLabels) && !b.allowOverlap && a.visible && c(f,
                                function(b) {
                                    c(a.points,
                                        function(a) {
            ...
            b.prototype.hideOverlappingLabels = function(a) {
                var b = a.length,
                    d, e, k, j, l, m, n, o, p;
                for (e = 0; e < b; e++) if (d = a[e]) d.oldOpacity = d.opacity,
                    d.newOpacity = 1;
                a.sort(function(a, b) {
                ...
                for (e = 0; e < b; e++) {
                    k = a[e];
                    for (d = e + 1; d < b; ++d) if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr, m = j.alignAttr, n = k.parentGroup, o = j.parentGroup, p = 2 * (k.box ? 0 : k.padding), l = !(m.x + o.translateX > l.x + n.translateX + (k.width - p) || m.x + o.translateX + (j.width - p) < l.x + n.translateX || m.y + o.translateY > l.y + n.translateY + (k.height - p) || m.y + o.translateY + (j.height - p) < l.y + n.translateY)))(k.labelrank < j.labelrank ? k: j).newOpacity = 0
                }
                c(a,
                    function(a) {
                        var b, c;
        ...
        ea = w.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                if (!a._hasTracking) o(a.trackerGroups,
                    function(b) {
            ...
            drawTrackerGraph: function() {
                ...
                if (e && !c) for (j = e + 1; j--;) d[j] === "M" && d.splice(j + 1, 0, d[j + 1] - i, d[j + 2], "L"),
                (j && d[j] === "M" || j === e) && d.splice(j, 0, "L", d[j - 2] + i, d[j - 1]);
                k ? k.attr({
                    d: d
                    ...
                    zIndex: 2
                }).add(a.group), o([a.tracker, a.markerGroup],
                    function(a) {
                        a.addClass("highcharts-tracker").on("mouseover", m).on("mouseout",
                            function(a) {
        ...
        if (I.column) wa.prototype.drawTracker = ea.drawTrackerPoint;
        if (I.pie) I.pie.prototype.drawTracker = ea.drawTrackerPoint;
        if (I.scatter) la.prototype.drawTracker = ea.drawTrackerPoint;
        s(pb.prototype, {
        ...
        s(gb.prototype, {
            ...
            zoom: function(a) {
                var b, c = this.pointer,
                    d = !1,
                    e; ! a || a.resetSelection ? o(this.axes,
                    function(a) {
                        b = a.zoom()
                    }) : o(a.xAxis.concat(a.yAxis),
                    function(a) {
                        var e = a.axis,
                            h = e.isXAxis;
                ...
                else if (!d && X(e)) this.resetZoomButton = e.destroy();
                ...
                o(b === "xy" ? [1, 0] : [1],
                    function(b) {
                        var b = c[b ? "xAxis": "yAxis"][0],
                            ...
                            i = i > h;
                        if (b.series.length && (i || l > E(j.dataMin, j.min)) && (!i || k < t(j.dataMax, j.max))) b.setExtremes(l, k, !1, !1, {
                            trigger: "pan"
                        }),
                            e = !0;
                        c[d] = h
        ...
        s(Ia.prototype, {
            select: function(a, b) {
                ...
                c.firePointEvent(a ? "select": "unselect", {
                    ...
                    function() {
                        ...
                        d.options.data[ra(c, d.data)] = c.options;
                        c.setState(a && "select");
                        b || o(e.getSelectedPoints(),
                            function(a) {
                                if (a.selected && a !== c) a.selected = a.options.selected = !1,
                                    d.options.data[ra(a, d.data)] = a.options,
                                    a.setState(""),
            ...
            onMouseOut: function() {
                ...
                if (!b || ra(this, b) === -1) this.setState(),
                    a.hoverPoint = null
            },
            ...
            setState: function(a, b) {
                ...
                if (! (a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                    ...
                    j && j.hide();
                        ...
                        else if (l) e.stateMarkerGraphic = j = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(o).add(e.markerGroup),
                            j.currentSymbol = l;
        ...
        s(R.prototype, {
            ...
            setVisible: function(a, b) {
                ...
                o(["group", "dataLabelsGroup", "markerGroup", "tracker"],
                    function(a) {
                        if (c[a]) c[a][f]()
                    });
